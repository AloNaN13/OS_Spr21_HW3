...
#
OBJS = server.o request.o segel.o client.o myQueue.o
TARGET = server
...
server: server.o request.o segel.o myQueue.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o myQueue.o $(LIBS)
